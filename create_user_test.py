...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в ответе есть поле code и оно = 400
    assert user_response.json()["code"] == 400
    # Проверяет, что в теле ответа атрибут message такой: "Имя пользователя введено некорректно.
...
def test_create_user_has_space_in_first_name_get_error_response(): #201 != 400
...
def test_create_user_number_type_first_name_get_error_response(): #500 != 400
    # В переменную user_body сохраняется обновлённое тело запроса
